            ...
            <div className="modex">
              ...
              <div className="row1">
                ...
                <div className="cl1">
                  ...
                  <input type="email" required placeholder='Enter email address' id='inputs'/>
                </div>
    
                <div className="cl1">
                  <label htmlFor="Mobile">Mobile number*</label>
                  <input type="tel" required placeholder='Enter Mobile number' id='inputs'/>
                </div>
              ...
              {/* Second Row - Academic Information */}
              <div className="row1">
                <div className="cl1">
              ...
              {/* Third Row - Performance Information */}
              <div className="row1">
                <div className="cl1">
                  <label htmlFor="Performance">Academic Performance (Latest)*</label>
                ...
                <div className="cl1">
                  <label htmlFor="Hours">Weekly Hours committed to this program*</label>
                  <input type="text" required placeholder='Enter your Time You can spend' id='inputs'/>
                </div>
    
                <div className="cl1">
                  <label htmlFor="Programs">Are you Involved in any programs*</label>
              ...
              <div className="dix">
                ...
                <div className="col1">
                  ...
                  <div className="cl1">
                    ...
                    <input type="text" required placeholder='Enter your Interests' id='inputs'/>
                  </div>
                ...
                <div className="col1">
                  ...
                  <div className="cl1">
                    <label htmlFor="Interest">Why are you interested in this program*</label>
                    <input type="text" required placeholder='Enter your Interests' id='inputs'/>
                  </div>
    
                  <div className="cl1">
                    <label htmlFor="Expectations">What do you expect through this program*</label>
                    <input type="text" required placeholder='Enter your expectations' id='inputs'/>
                  </div>
                </div>
                  ...
                  <div className="box">
                    ...
                    <div className="sk1">
                      ...
                      <label htmlFor="TailWindCSS">
                        <input type="checkbox" name="TailWindCSS" value="TailWindCSS" />
                        TailWindCSS
                      </label>
                    ...
                    <div className="sk1">
                      ...
                      <label htmlFor="MaterialUI">
                        <input type="checkbox" name="MaterialUI" value="MaterialUI" />
                        Material UI
                      </label>
                    ...
                    <div className="sk1">
                      ...
                      <label htmlFor="AfterEffects">
                        <input type="checkbox" name="AfterEffects" value="AfterEffects" />
                        Adobe After Effects
                      </label>
                      <label htmlFor="PremierePro">
                        <input type="checkbox" name="PremierePro" value="PremierePro" />
                        Adobe Premiere Pro
                      </label>
              ...
              {/* Final Section - Resume Upload and Submit */}
              <div className="final">
                <div className="part1">
